...
const NavBar = () => {
  return (
    <nav className="bg-snu-purple-900 drop-shadow-md list-none flex-shrink-0 flex flex-col h-full w-14 hover:w-60 items-start transition-all duration-300 py-2 text-white">
