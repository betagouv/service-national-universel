...
const TicketPreview = ({ ticket, handleTicketClose, handleTicketOpen }) => {
  return (
    <div className="flex w-full flex-1 overflow-hidden">
      <div className="ml-1 mr-2 mb-2 mt-1 flex flex-1 overflow-hidden rounded-lg bg-white drop-shadow-md">
        ...
        <div className="flex w-full flex-col overflow-hidden p-4">
          <TicketHeader ticket={ticket} handleTicketClose={handleTicketClose} handleTicketOpen={handleTicketOpen} />
