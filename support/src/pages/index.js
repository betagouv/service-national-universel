...
import SubPhase2 from "./subphase2";
      ...
      <Wrapper>
        <div className="grid grid-cols-1 grid-rows-[auto,180px,auto]">
          ...
          <div className="md:px-10 px-6 flex lg:flex flex-col lg:flex-nowrap max-w-screen-2xl mx-auto flex-wrap grid-cols-2 md:grid md:flex-row row-span-2 row-start-2 col-span-full gap-2.5">
            <Card title="Gestion du compte utilisateur" small="mon compte" imgSrc="mon-compte.png" />
            <Card title="L’inscription du volontaire" small="Phase 0" imgSrc="phase-0.png" />
            <Card title="Le séjour de cohésion" small="Phase 1" imgSrc="phase-1.png" />
            <Card title="La mission d’intérêt général" small="Phase 2" imgSrc="phase-2.png" />
            <Card title="L’engagement du volontaire" small="Phase 3" imgSrc="phase-3.png" />
          </div>
        </div>
