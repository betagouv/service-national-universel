...
const SubPhase2 = () => {
  return (
    <Wrapper>
      <Banner title="Critères d'éligibilité MIG et structure" category="Phase 2" text="Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua" tag="Critères d'éligibilité MIG et structure" />
