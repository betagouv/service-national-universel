  ...
  return (
    <div className="my-6 text-[#161616]">
      <label className={`w-full my-2 ${correction || error ? "text-[#CE0500]" : "text-[#161616]}"}`}>
        {label}
        <textarea
          className={`flex w-full items-center justify-between gap-3 border-b-[2px] bg-[#EEEEEE] mt-2 px-4 py-2 ${correction || error ? "border-[#CE0500]" : "border-[#3A3A3A]"} ${
            rest?.readOnly ? "text-gray-500 cursor-not-allowed" : ""
          }
          rounded-t-[4px]`}
