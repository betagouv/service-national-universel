...
const ModalTuesdayLocalTransport = ({ isOpen, onClose }) => {
  return (
    <Modal isOpen={isOpen} onClose={onClose} className="max-w-xl bg-white rounded-xl p-6">
      <div className="text-sm text-gray-700 leading-5 space-y-4">
        ...
        <p>
          <strong>Votre départ est maintenu à mardi 13 juin</strong>, les informations de votre transport vous seront transmises par vos services locaux. Nous mettons tout en œuvre
          pour veiller à ce que le transport vers votre centre se déroule dans les meilleures conditions.
        </p>
...
export default ModalTuesdayLocalTransport;
