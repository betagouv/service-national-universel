...
export default function application({ application }) {
  ...
  return (
    <Link
      to="/candidature"
      className="group flex shrink-0 flex-col w-56 justify-start items-start border shadow-md rounded-lg bg-white p-3 hover:-translate-y-1 transition duration-100 ease-in">
