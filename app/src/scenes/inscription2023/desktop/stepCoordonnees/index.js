...
export default function StepCoordonnees() {
  const [data, setData] = useState(defaultState); // container
  const [errors, setErrors] = useState({}); //contaier
  const [corrections, setCorrections] = useState({}); //container

  const [loading, setLoading] = useState(false); //container
