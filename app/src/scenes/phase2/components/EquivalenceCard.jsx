...
export default function EquivalenceCard({ equivalence }) {
  return (
    <Link to={`/phase2/equivalence/${equivalence.id}`} className="bg-white rounded-xl border w-72 md:w-96 only:w-full only:md:w-96 flex-none snap-always snap-center shadow-sm">
