...
import { EQUIVALENCE_STATUS, translateApplication } from "snu-lib";
  ...
  return (
    <div className="bg-white rounded-xl border  w-72 md:w-96 flex-none snap-always snap-center first:ml-4 md:first:ml-0 last:mr-4 md:last:mr-0">
      ...
      <div className="h-36 px-3 py-2.5 flex flex-col justify-between">
        <p className={`text-xs rounded-full px-2 py-1 w-fit ${applicationBadgeStyle[equivalence.status]}`}>{translateApplication(equivalence.status)}</p>
