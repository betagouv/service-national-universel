...
export default function ApplicationCard({ application }) {
  return (
    <Link
      ...
      className="bg-white rounded-xl border p-3 w-72 md:w-96 w-full only:md:w-96  h-48 flex flex-col justify-between flex-none snap-always snap-center shadow-sm">
