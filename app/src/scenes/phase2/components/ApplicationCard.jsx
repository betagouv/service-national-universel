...
export default function ApplicationCard({ application }) {
  return (
    <Link
      ...
      className="bg-white rounded-xl border p-3 w-72 md:w-96 h-48 flex flex-col justify-between flex-none snap-always snap-center">
      ...
      <div className="flex justify-between items-end">
        <p className="text-xs leading-5 text-gray-400 line-clamp-1">
