        ...
        <div className="md:my-12 md:mx-10 w-full">
          <div className="flex flex-col-reverse md:flex-row sm:py-4 sm:px-4 md:py-0 md:px-0 items-center justify-between rounded-lg bg-white ">
            <div className="md:w-1/2 md:py-12 md:pl-10">
              <div className="text-[48px] font-medium leading-tight tracking-tight">
                Mon engagement,
                <br />
                <span className="text-blue-600"> Un temps au service de la Nation</span>
              </div>
              <div className="left-7 mt-5 text-base text-gray-800">
                Engagez-vous selon vos préférences ! C&apos;est vous qui choisissez la cause que vous voulez soutenir à travers votre phase 2. Vous allez vous sentir pleinement
                utile à la société.
              </div>
