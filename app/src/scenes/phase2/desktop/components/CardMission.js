...
export default function application({ application }) {
  ...
  return (
    <Link
      ...
      className="group flex w-56 flex-col items-start justify-start rounded-lg bg-white p-3 pb-4 shadow-nina transition duration-100 ease-in hover:-translate-y-1">
