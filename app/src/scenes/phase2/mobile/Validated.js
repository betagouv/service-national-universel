        ...
        <div className="flex gap-7 mt-6 flex-col w-full">
          ...
          <div className="relative" ref={refAttestationButton}>
            <button
              ...
              className="flex justify-between gap-3 items-center rounded-full border-[1px] border-blue-600 bg-blue-600 px-3 py-2 disabled:opacity-50 disabled:cursor-wait w-3/4"
