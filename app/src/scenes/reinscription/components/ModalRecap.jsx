...
export default function ModalConfirm({ isOpen, topTitle = "alerte", title, message, onChange, onCancel, onConfirm, confirmText = "Confirmer", cancelText = "Annuler", young }) {
  ...
  return (
    <Modal centered isOpen={isOpen} toggle={onCancel || onChange}>
      <button className="mt-4 mr-2 flex items-center justify-end gap-2 pb-2 text-sm text-[#000091]" onClick={onCancel}>
        Fermer
