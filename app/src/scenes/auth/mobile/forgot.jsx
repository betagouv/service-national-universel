      ...
      <div className="bg-white px-4 pt-4 pb-12">
        ...
        {!done ? (
          ...
          <div className="text-base text-[#161616] ">
            <span className="font-medium"> Un email de réinitialisation de mot de passe a été envoyé à </span> "<b>{email}</b>" <br /> <br /> Cet email contient un lien permettant
            de réinitialiser votre mot de passe. <br /> <br /> Vous allez le recevoir d’ici quelques minutes, pensez à vérifier vos spams et courriers indésirables. <br /> <br />{" "}
            Si vous ne recevez aucun email, cela veut dire que vous n&apos;avez pas encore de compte.
          </div>
        )}
