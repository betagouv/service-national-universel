...
const ActivationCodeModalContent = ({ onConfirm, onCancel }) => {
    ...
    <>
      ...
      <Modal.Subtitle>
        <div className="md:text-center mb-3">
          Vous venez de recevoir un code d’activation sur la boîte mail de <strong className="text-gray-900">gaspard.dupond@gmail.com</strong>
        </div>
      </Modal.Subtitle>
      ...
      <Modal.Buttons onCancel={onCancel} cancelText="Annuler" onConfirm={() => onConfirm()} confirmText="Valider" />
    </>
  );
};
