...
import { inscriptionModificationOpenForYoungs } from "../../utils";
    ...
    <HeroContainer>
      <Hero>
        ...
        <Content showAlert={showAlert}>
          ...
          {inscriptionModificationOpenForYoungs(young.cohort) && (
            <IconContainer>
              ...
              <div>
                <p style={{ color: "#000" }}>
                  <strong>Votre dossier d&apos;inscription est en attente de correction.</strong>
                </p>
                {young.inscriptionCorrectionMessage && young.inscriptionCorrectionMessage?.trim() && (
                  <>
                    <p>Merci de vous reconnecter à votre dossier d&apos;inscription et d&apos;effectuer les modifications demandées par votre référent :</p>
