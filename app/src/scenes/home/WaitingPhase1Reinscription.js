    ...
    <div className="flex lg:hidden w-full">
      <div className="flex flex-col-reverse ">
        <div className="px-4 pb-4">
          ...
          <div className="left-7 text-[#738297] mt-3">
            {/* Précisez les conditions à venir et 2022 */}
            {young.status === YOUNG_STATUS.WAITING_LIST
              ? "Vous étiez sur liste complémentaire sur un séjour en 2022."
              : false
              ? "Vous êtes inscrit sur un séjour “à venir”."
              : false
              ? "En 2022, vous n'avez pas pu participer au séjour de cohésion."
              : null}
          </div>
