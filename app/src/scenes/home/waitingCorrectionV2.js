                  ...
                  return (
                    <>
                      <div key={i} className="flex items-center justify-between gap-4 pr-2">
                        ...
                        <button
                          className="dissabled:cursor-not-allowed rounded-lg border-[1px] border-blue-600 px-2 py-2 text-sm font-medium text-blue-600 hover:bg-blue-600 hover:text-white disabled:bg-gray-100 disabled:opacity-50"
