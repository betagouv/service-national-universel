  ...
  return (
    <Hero>
      ...
      <Content showAlert={showAlert}>
        ...
        <p>
          Votre candidature a été placée <b style={{ color: "#5145cd" }}>en liste complémentaire</b> par l'administration. Vous serez informé(e) par e-mail si une place venait à se
          libérer vous permettant ainsi de participer au SNU.
        </p>
        <Separator />
