                    ...
                    {({ values, handleChange, handleSubmit, errors, touched }) => (
                      <>
                        <Title>
                          <span>
                            {isPlural
                              ? "Seuls les représentants légaux sont habilités à valider ce consentement"
                              : "Seul le représentant légal est habilité à valider ce consentement"}
                          </span>
                        </Title>
                        <FormGroup>
                          ...
                          <Col>
                            <RadioLabel>
                              ...
                              <label htmlFor="imageRight_true">
                                ...
                                journalistes dûment accrédités par les services communication du ministère et/ou des préfecture à enregistrer, reproduire et représenter l’image
                                et/ou la voix du volontaire représenté en partie ou en intégralité, ensemble ou séparément, sur leurs publications respectives.
                              </label>
                            </RadioLabel>
                            <RadioLabel>
                              <Field
