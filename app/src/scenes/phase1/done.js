            ...
            <section>
              ...
              <div className="lg:flex lg:flex-row">
                <article className="bg-gray-50 px-4 py-8 rounded-md md:mr-4">
                  ...
                  <a
                    className="text-sm text-blue-600 underline hover:text-blue-600"
                  ...
                  <div className="flex items-center">
                    <DownloadAttestationButton
                      young={young}
                      uri="1"
                      className="flex items-center border-[1px] border-blue-600 rounded-lg px-4 py-2.5 font-sm leading-5  mt-4 shadow-sm bg-blue-600 text-white mr-3">
                      Télécharger mon attestation
                    </DownloadAttestationButton>
                    <MailAttestationButton
                      className="flex items-center border-[1px] border-blue-600 rounded-lg px-4 py-2.5 font-sm leading-5 mt-4 shadow-sm text-blue-600 "
                      young={young}
                      type="1"
