...
export default function NextStep() {
  return (
    <div className="mx-4 mb-4 flex flex-col items-center justify-between gap-4 rounded-xl bg-gray-100 p-[1rem] md:flex-row md:bg-white md:p-[2rem] md:shadow-ninaBlock">
      <p className="text-center text-xl font-bold leading-7 md:hidden">Et maintenant, votre parcours au sein du SNU se poursuit avec la phase engagement</p>
      <p className="hidden text-left text-xl font-bold leading-7 md:block md:w-2/3">Et maintenant, votre parcours au sein du SNU se poursuit avec la phase engagement</p>
      <ButtonLinkPrimary
        to="/phase2"
