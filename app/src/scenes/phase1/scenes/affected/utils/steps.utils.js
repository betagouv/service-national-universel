...
const isStepAgreementDone = (young) => isStepPDRDone(young) && young?.youngPhase1Agreement === "true";
const isStepConvocationDone = (young) => isStepAgreementDone(young) && young?.convocationFileDownload === "true";
const isStepMedicalFieldDone = (young) => isStepConvocationDone(young) && young?.cohesionStayMedicalFileDownload === "true";
