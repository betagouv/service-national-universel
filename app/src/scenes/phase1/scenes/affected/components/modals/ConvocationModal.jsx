...
export default function ConvocationModal({ isOpen, setIsOpen }) {
  return (
    <Modal isOpen={isOpen} onClose={() => setIsOpen(false)} className="w-full bg-white p-4 md:max-w-4xl md:p-6">
      <div className="flex justify-end">
        <button onClick={() => setIsOpen(false)} className="text-gray-600 p-2 translate-x-2 -translate-y-2 disabled:cursor-wait disabled:bg-gray-200">
