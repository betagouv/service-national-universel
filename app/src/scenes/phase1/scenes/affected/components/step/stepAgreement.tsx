      ...
      <StepCard variant="done" index={index}>
        <div className="flex items-center flex-col md:flex-row gap-3 justify-between text-sm">
          <div>
            ...
            {isCLE ? (
              <p className="mt-[0.75rem] md:mt-[0.25rem] text-gray-500">Confirmez votre participation au séjour pour accéder à votre convocation.</p>
            ) : (
              <p className="mt-[0.75rem] md:mt-[0.25rem] text-gray-500">
                Vous devez confirmer votre participation au séjour <b>sous 3 jours</b> à partir de votre affectation. Passé ce délai, votre place sera proposée à un autre
                volontaire.
              </p>
            )}
          </div>
