...
export default function StepAgreement({ departureDate, returnDate }) {
      ...
      <StepCard state="todo" stepNumber={2}>
        <div className="flex items-center flex-col md:flex-row gap-3 justify-between text-sm">
          <div>
            ...
            <p className="text-sm text-gray-600 mt-2">Vous devez confirmer votre participation au séjour avant votre départ.</p>
          </div>
  ...
  return (
    <StepCard state="done" stepNumber={2}>
      <div className="flex items-center flex-col md:flex-row gap-3 justify-between text-sm">
        <div>
          <p className="font-semibold">Confirmation de votre participation au séjour</p>
          <p className="leading-tight mt-2">Vous avez confirmé votre participation au séjour.</p>
        </div>
        <div className="w-full md:w-auto mt-1 md:mt-0">
