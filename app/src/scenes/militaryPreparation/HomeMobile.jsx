        ...
        {canViewMissions ? (
          ...
          <>
            <button
              disabled
              data-tip
              data-for="tooltip-delai-pm-mobile"
            ...
            <ReactTooltip id="tooltip-delai-pm-mobile" className="!rounded-lg bg-white text-gray-800 !opacity-100 shadow-xl max-w-sm" arrowColor="white">
