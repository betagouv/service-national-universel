      ...
      <div className="bg-[#f9f6f2] flex justify-center py-10">
        <div className="bg-white basis-[70%] mx-auto my-0 px-[102px] py-[60px]">
          ...
          <div className="flex justify-end gap-4">
            <button className="flex items-center justify-center px-3 py-2 border-[1px] border-[#000091] text-[#000091]" onClick={handleClick}>
              Plus tard
            </button>
            <button className={`flex items-center justify-center px-3 py-2 cursor-pointer bg-[#000091] text-white`} onClick={() => logout()}>
              Continuer
            </button>
          </div>
        </div>
