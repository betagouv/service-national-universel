...
import { COHESION_STAY_END } from "snu-lib/date";
...
export default function Presentation({ step }) {
  ...
  function computeSejourDate() {
    if (young.cohort) {
      const startDate = COHESION_STAY_END[young.cohort];
      if (startDate) {
  ...
  return (
    <>
      <Navbar step={step} />
      <div className="bg-white py-[60px] px-[90px] text-[#161616] max-w-[792px] m-auto">
