...
const region2zone = {
  ...
  "Polynésie française": "DOM",
  "Nouvelle-Calédonie": "DOM",
  Etranger: "Etranger",
};

export { departmentLookUp, departmentList, getDepartmentNumber, regionList, department2region, region2department, getDepartmentByZip, getRegionByZip, region2zone };
