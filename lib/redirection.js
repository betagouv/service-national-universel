const WAITING_CORRECTION = [
  {
    ...
    redirect: "/inscription2023/profile",
  },
  {
    field: [
      "birthdateAt",
    ...
    redirect: "/inscription2023/eligibilite",
  },
  {
    field: [
      "parent1Status",
    ...
    redirect: "/inscription2023/representants",
  },
  {
    field: [
      "gender",
    ...
    redirect: "/inscription2023/coordonnee",
  },
  {
    field: ["cniFile"],
    redirect: "/inscription2023/documents",
  },
];
