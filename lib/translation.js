...
const translateField = (field) => {
  switch (field) {
    ...
    case "parent1Status":
      return "Statut du parent 1";
    case "parent1FirstName":
      return "Prénom du parent 1";
    case "parent1LastName":
      return "Nom du parent 1";
    case "parent1Email":
      return "Email du parent 1";
    case "parent1Phone":
      return "Téléphone du parent 1";
    case "parent1Address":
      return "Adresse du parent 1";
    case "parent1Zip":
      return "Code postal du parent 1";
    case "parent1City":
      return "Ville du parent 1";
    case "parent1Department":
      return "Département du parent 1";
    case "parent1Region":
      return "Région du parent 1";
    case "parent2Status":
      return "Statut du parent 2";
    case "parent2FirstName":
      return "Prénom du parent 2";
    case "parent2LastName":
      return "Nom du parent 2";
    case "parent2Email":
      return "Email du parent 2";
    case "parent2Phone":
      return "Téléphone du parent 2";
    case "parent2Address":
      return "Adresse du parent 2";
    case "parent2Zip":
      return "Code postal du parent 2";
    case "parent2City":
      return "Ville du parent 2";
    case "parent2Department":
      return "Département du parent 2";
    case "parent2Region":
      return "Région du parent 2";
...
const translateCorrectionReason = (reason) => {
  switch (reason) {
    case "UNREADABLE":
      return "Pièce illisible (supprimer le fichier)";
    case "MISSING_FRONT":
      return "Recto à fournir";
    case "MISSING_BACK":
      return "Verso à fournir";
    case "NOT_SUITABLE":
      return "Pièce ne convenant pas... (supprimer le fichier)";
    case "OTHER":
      return "Autre (supprimer le fichier)";
    default:
      return reason;
  }
};
