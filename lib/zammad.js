...
const totalOpenedTickets = (tickets) => tickets?.filter((ticket) => ticket?.state_id === 2)?.length;
const totalNewTickets = (tickets) => tickets?.filter((ticket) => ticket?.state_id === 1)?.length;
