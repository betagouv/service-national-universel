...
function canViewPlanDeRepartition(actor) {
  return [ROLES.ADMIN, ROLES.REFERENT_REGION].includes(actor.role);
}

function canEditPlanDeRepartitionDepartment(actor) {
  return [ROLES.ADMIN, ROLES.REFERENT_REGION].includes(actor.role);
}

function canEditPlanDeRepartitionRegion(actor) {
  return [ROLES.ADMIN].includes(actor.role);
}
...
module.exports = {
  ...
  canApplyToPhase2,
  canViewPlanDeRepartition,
  canEditPlanDeRepartitionDepartment,
  canEditPlanDeRepartitionRegion,
};
