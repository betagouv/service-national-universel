...
function canEditSchemaDeRepartitionRegion(actor) {
  return [ROLES.ADMIN].includes(actor.role);
}

function canEditSchemaDeRepartitionDepartment(actor) {
  return [ROLES.ADMIN, ROLES.REFERENT_REGION].includes(actor.role);
}
...
module.exports = {
  ...
  canEditSchemaDeRepartitionDepartment,
  canEditSchemaDeRepartitionRegion,
};
