...
function canUpdateStatus(newYoung, oldYoung) {
  ...
  const youngStatus = newYoung.status === "VALIDATED";
  const youngStatusPhase1 = newYoung.statusPhase1 === "DONE";
  const youngStatusPhase2 = newYoung.statusPhase2 === "VALIDATED";
  const youngStatusPhase3 = newYoung.statusPhase3 === "VALIDATED";
  const youngStatusMilitaryPrepFiles = newYoung.statusMilitaryPreparationFiles === "VALIDATED";
  const youngStatusPhase2Contract = newYoung.statusPhase2Contract === "VALIDATED";
  const youngGender = newYoung.gender === "female";
