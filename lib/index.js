...
function inscriptionModificationOpenForYoungs(cohort) {
  switch (cohort) {
    ...
    case "Juillet 2022":
      return new Date() < new Date(2022, 4, 5); // before 5 mai 2022 morning
    case "Octobre 2022":
      return new Date() < new Date(2022, 10, 9);
    default:
      return new Date() < new Date(2022, 10, 9); // before 2 mai 2022 morning
  }
}
...
function inscriptionCreationOpenForYoungs(cohort, allowed = false) {
  ...
  switch (cohort) {
    ...
    case "Octobre 2022":
      return new Date() < new Date(2022, 10, 09);
    default:
      return new Date() < new Date(2022, 10, 09); // before 2 mai 2022 morning
  }
}
