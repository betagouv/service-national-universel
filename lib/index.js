...
function inscriptionModificationOpenForYoungs(cohort) {
  switch (cohort) {
    ...
    case "Juillet 2022":
      return new Date() < new Date(2022, 4, 5); // before 5 mai 2022 morning
    case "Février 2023 - C":
      console.log(new Date(2023, 0, 9, 23, 59));
      return new Date() <= new Date(2022, 11, 9, 23, 59); // before 4 janvier 2023 morning
    case "Avril 2023 - A":
      return new Date() < new Date(2023, 1, 7); // before 7 fevrier 2023 morning
    case "Avril 2023 - B":
      return new Date() < new Date(2023, 1, 21); // before 21 fevrier 2023 morning
    case "Juin 2023":
