...
function inscriptionModificationOpenForYoungs(cohort) {
  switch (cohort) {
    ...
    case "2021":
      return false;
    case "2022":
      return new Date() < new Date(2022, 9, 10); // before october 9th 2022 morning
    case "Février 2022":
    ...
    case "Octobre 2022":
      return (
        new Date() > new Date(2022, 8, 1) && new Date() < new Date(2022, 9, 10)
      ); /// Between september 12th and october 9th (included)
    default:
      return (
        new Date() > new Date(2022, 8, 1) && new Date() < new Date(2022, 9, 10)
      ); /// Between september 12th and october 9th (included)
