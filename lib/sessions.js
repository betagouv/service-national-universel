const { YOUNG_STATUS, YOUNG_STATUS_PHASE1 } = require("./constants");
...
const FILLING_RATE_THRESHOLD = 1.05;

const shouldCheckFillRateOnCohortChange = (young) => {
  if ((young.status === YOUNG_STATUS.VALIDATED || young.status === YOUNG_STATUS.WAITING_LIST) && young.statusPhase1 === YOUNG_STATUS_PHASE1.WAITING_AFFECTATION) {
    return true;
  }
  return false;
};
