...
const SENDINBLUE_TEMPLATES = {
  ...
  SESSION_WAITING_VALIDATION: "637",
...
const PHASE1_HEADCENTER_ACCESS_LIMIT = {
  ...
  "Février 2023 - C": new Date("04/19/2023"),
};
...
const PHASE1_HEADCENTER_OPEN_ACCESS_CHECK_PRESENCE = {
  ...
  "Février 2023 - C": new Date("01/19/2023"),
};
...
const PHASE1_YOUNG_ACCESS_LIMIT = {
  ...
  "Avril 2023 - A": new Date(2023, 1, 7), // before 7 fevrier 2023 morning
  "Avril 2023 - B": new Date(2023, 1, 21), // before 21 fevrier 2023 morning
