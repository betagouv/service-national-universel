                        ...
                        <div style={{ display: "flex", flexWrap: "wrap" }}>
                          <div>
                            <FieldWithWidth
                              ...
                              onChange={async (e) => {
                                handleChange(e);
                                const newBirthCityZip = e.target.value;
                                if (newBirthCityZip?.length === 5) {
                                  const response = await fetch(`https://geo.api.gouv.fr/communes?codePostal=${newBirthCityZip}`, {
                                    mode: "cors",
                                    method: "GET",
                ...
                <FormRow align="center">
                  ...
                  <Col md={8}>
                    <FieldWithWidth
                      ...
                      value={values.email}
                      onChange={(e) => {
                        if (e.target.value) validateField("email");
                        handleChange(e);
                      }}
                    />
                  ...
                  <Col md={8}>
                    <FieldWithWidth
                      ...
                      onChange={(e) => {
                        if (e.target.value) validateField("verifyEmail");
                        handleChange(e);
                      }}
                    />
                  ...
                  <Col md={8}>
                    <ContainerPass>
                      <Field
                        ...
                        onChange={(e) => {
                          if (e.target.value) validateField("password");
                          handleChange(e);
                        }}
                      />
                  ...
                  <Col md={8}>
                    <ContainerPass>
                      <Field
                        ...
                        onChange={(e) => {
                          if (e.target.value) validateField("verifyPassword");
                          handleChange(e);
                        }}
                      />
                      <EyeIcon src={passwordText ? EyeClose : EyeOpen} onClick={() => setPasswordText(!passwordText)} />
