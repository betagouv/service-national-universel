export enum PERMISSION_CODES {
  ...
  CANDIDATURE_CLE = "CandidatureCle",
  CANDIDATURE_CREATE = "CandidatureCreate",
  CANDIDATURE_FULL = "CandidatureFull",
  CANDIDATURE_READ = "CandidatureRead",
  CANDIDATURE_REGION = "CandidatureRegion",
  CANDIDATURE_DEPARTMENT = "CandidatureDepartment",
  CANDIDATURE_WRITE = "CandidatureWrite",
  CANDIDATURE_YOUNG_FULL = "CandidatureYoungFull",
