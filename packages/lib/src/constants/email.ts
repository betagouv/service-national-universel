...
const SENDINBLUE_TEMPLATES = {
  ...
  invitationReferent: {
    [ROLES.REFERENT_DEPARTMENT]: "3020",
    [ROLES.REFERENT_REGION]: "2380",
    [ROLES.RESPONSIBLE]: "2503",
    [ROLES.SUPERVISOR]: "2503",
    [ROLES.ADMIN]: "161",
    [ROLES.HEAD_CENTER]: "2213",
    [ROLES.HEAD_CENTER_ADJOINT]: "2784",
    [ROLES.REFERENT_SANITAIRE]: "2785",
    [ROLES.VISITOR]: "2499",
    [ROLES.DSNJ]: "662",
    [ROLES.INJEP]: "662",
  ...
  referent: {
    WELCOME_REF_DEP: "2220",
    ON_BOARDING_REF_DEP_J7: "2990",
    ON_BOARDING_REF_DEP_J21: "2991",
    WELCOME_REF_REG: "391",
    YOUNG_CHANGE_COHORT: "2506",
    ...
    // MIG
    MISSION_WAITING_CORRECTION: "2505",
    MISSION_WAITING_VALIDATION: "2502",
    MISSION_VALIDATED: "2383",
    MISSION_END: "213",
    MISSION_CANCEL: "2498",
    NEW_MISSION: "2872",
    NEW_MISSION_REMINDER: "1676",
    MISSION_REFUSED: "165",
    CANCEL_APPLICATION: "155",
    CANCEL_APPLICATION_PHASE_2_VALIDATED: "599",
    ABANDON_APPLICATION: "2382",
    VALIDATE_APPLICATION_TUTOR: "196",
    NEW_APPLICATION_MIG: "2899",
    YOUNG_VALIDATED: "173",
    APPLICATION_REMINDER: "2379",

    CONTRACT_DRAFT: "199",

    STRUCTURE_REGISTERED: "2497",

    MISSION_ARCHIVED: "204",
    MISSION_ARCHIVED_1_WEEK_NOTICE: "2504",

    // PREPA MILITAIRE
    MILITARY_PREPARATION_DOCS_SUBMITTED: "2500",
    MILITARY_PREPARATION_DOCS_VALIDATED: "2501",
  ...
  young: {
    ...
    PHASE1_AFFECTATION: "2542",
    INSCRIPTION_WAITING_CONSENT: "1245",
    CHANGE_PDR_BEFORE_DEPARTURE: "2270",
    CHANGE_PDR_BEFORE_RETURN_CLE: "2307",
    CHANGE_PDR_BEFORE_RETURN_HTS: "2920",

    PHASE1_AGREEMENT: "2576",
    PHASE_1_CHANGEMENT_CENTRE: "2276",
    ...
    APPLICATION_CANCEL_1_WEEK_NOTICE_PM: "3177",
    APPLICATION_CANCEL_13_DAY_NOTICE: "1230",
    APPLICATION_CANCEL_13_DAY_NOTICE_PM: "3178",
    // CLE
  ...
  CLE: {
    ...
    INVITATION_REFERENT_CLASSE_TO_INSCRIPTION_TEMPLATE: "1391",
    INVITATION_REFERENT_CLASSE_TO_CONFIRMATION_TEMPLATE: "1427",
    SUPPRESSION_ANCIEN_REFERENT_CLASSE_TEMPLATE: "",
    PHASE_1_MODIFICATION_LIGNE: "2614",
  },
  // Imports
  IMPORT_AUTO: "2324",
  // Opérations
