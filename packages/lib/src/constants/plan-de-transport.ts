const PDT_IMPORT_ERRORS = {
  ...
  BAD_CENTER_MATRICULE: "BAD_CENTER_MATRICULE",
  BAD_CLASSE_ID: "BAD_CLASSE_ID",
  BAD_PDR_ID: "BAD_PDR_ID",
  BAD_PDR_MATRICULE: "BAD_PDR_MATRICULE",
  BAD_PDR_DEPARTEMENT: "BAD_PDR_DEPARTEMENT",
  BAD_MERGED_LINE_ID: "BAD_MERGED_LINE_ID",
  BAD_MIRROR_LINE_ID: "BAD_MIRROR_LINE_ID",
  SAME_MIRROR_LINE_ID: "SAME_MIRROR_LINE_ID",
...
const PDT_IMPORT_ERRORS_TRANSLATION = {
  ...
  BAD_CENTER_MATRICULE: { text: "Le matricule du centre %s non existant.", tooltip: "Les matricules des centres sont transmis dans le schéma de répartition." },
  ...
  BAD_MIRROR_LINE_ID: { text: "Numéro de ligne miroir %s inconnue", tooltip: "La ligne miroir doit être présente dans le fichier." },
  SAME_MIRROR_LINE_ID: { text: "Une ligne ne peut pas être sa propre ligne miroir.", tooltip: "Veuillez vérifier la colonne LIGNE MIROIR." },
