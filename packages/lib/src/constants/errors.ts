const ERRORS = {
  ...
  ETABLISSEMENT_NOT_FOUND: "ETABLISSEMENT_NOT_FOUND",
  CANNOT_PARSE_CSV: "CANNOT_PARSE_CSV",
  COHESION_CENTER_NOT_FOUND: "COHESION_CENTER_NOT_FOUND",
  PDR_NOT_FOUND: "PDR_NOT_FOUND",
  SESSION_NOT_FOUND: "SESSION_NOT_FOUND",
  REFERENT_INACTIVE: "REFERENT_INACTIVE",
} as const;

const ERROR_FILTER = [ERRORS.NOT_FOUND, ERRORS.OPERATION_UNAUTHORIZED, ERRORS.OPERATION_NOT_ALLOWED];

export { ERRORS, ERROR_FILTER };
