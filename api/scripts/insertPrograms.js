...
const programs = [
  {
    ...
    descriptionFor: "les jeunes de 16 à 25 ans, jusqu’à 30 ans en situation de handicap, sans condition de diplôme.",
    descriptionMoney: "Oui, à hauteur de 580 euros net par mois. ",
    descriptionDuration: "24 heures par semaine minimum, entre 6 et 12 mois.",
  },
  {
    ...
    descriptionFor: "tous les résidents du territoire français, âgés de plus de 16 ans.",
    descriptionMoney: "Non",
    descriptionDuration:
      "Les missions peuvent être courtes ou longues, ponctuelles ou récurrentes, en fonction des besoins des organisations et des envies des bénévoles.",
  },
  {
    ...
    descriptionFor: "les français de 17 à 40 ans ayant une bonne aptitude physique et ayant effectué leur JDC",
    descriptionMoney: "Oui, selon une grille fixe",
    descriptionDuration: "Jusqu'à 30 jours par an",
  },
  {
  ...
  },
  {
    ...
    url: "https://www.police-nationale.interieur.gouv.fr/Nos-metiers/Reserve-civile/Vous-etes-citoyen",
    visibility: "NATIONAL",
    type: "Engagement",
  ...
  },
  {
    ...
    description:
      "C'est la possibilité de s‘engager bénévolement pour transmettre et faire vivre les valeurs de la République à l’École, aux côtés des enseignants, ou dans le cadre d’activités périscolaires.",
    url: "https://www.education.gouv.fr/la-reserve-citoyenne-3020",
    visibility: "NATIONAL",
    type: "Engagement",
    imageString: "reserve-education.jpg",
    descriptionFor: "les citoyens français de plus de 18 ans, dotés de compétences spécifiques.",
    descriptionMoney: "Dans certains cas, oui.",
    descriptionDuration: "Elle est variable en fonction des situations.",
  },
  {
    name: "Sapeurs Pompier volontaires",
    description:
      "Un engagement en 4 cycles de formation sucessifs permettant de découvrir les matériels et les comportements qui sauvent, l’engagement citoyen et de mettre en œuvre procédure et matériels dans des contextes de plus en plus proches de la réalité opérationnelle.",
    ...
    descriptionFor: "les citoyens français et résidents réguliers âgés de 16 à 60 ans. ",
    descriptionMoney: "Oui",
    descriptionDuration: "De 1 à 3 ans, à raison de 30 heures de formations puis de 6 interventions par mois en moyenne",
  },
  {
    name: "Chantiers de jeune bénévoles",
    description:
      "Les chantiers de jeunes bénévoles vous proposent des expériences de bénévolat en France et à l’étranger et rassemblent des jeunes autour d’un projet utile à la collectivité.",
    url: "https://www.jeunes.gouv.fr/Chantiers-de-jeunes-benevoles",
    visibility: "NATIONAL",
    type: "Engagement",
    imageString: "jeune-benevole.jpg",
    descriptionFor: "les jeunes à partir de 13 ans. ",
    descriptionMoney: "Non",
    descriptionDuration: "De 2 à 3 semaine",
  },
  // {
  //   name: "BAFA",
  //   description:
  ...
  // },
  {
    ...
    description:
      "Junior Association est une démarche souple qui permet à tout groupe de jeunes de mettre en place des projets dans une dynamique associative.",
    url: "https://juniorassociation.org/index.php",
    visibility: "NATIONAL",
    type: "Engagement",
    imageString: "juniors-association.jpg",
    descriptionFor: "les jeunes de 11 à 18 ans.",
    descriptionMoney: "Non",
    descriptionDuration: "Cela dépend de la Junior Association",
  },
  {
    name: "Le Corps européen de solidarité",
    description:
      "Le corps européen de solidarité offre la possibilité de se porter volontaires dans des projets organisés en France ou à l’étranger et destinés à aider des communautés et des personnes dans toute l’Europe.",
    url: "https://corpseuropeensolidarite.fr/",
    visibility: "NATIONAL",
    type: "Engagement",
    imageString: "corps-europeen-solidarite.png",
    descriptionFor: "les jeunes de 18 à 30 ans.",
    descriptionMoney: "Non",
    descriptionDuration: "De 2 à 12 mois",
  },
  {
    ...
    descriptionFor: "les citoyens du monde de plus de 18 ans (sans condition de nationalité ni limite d'âge) ",
    descriptionMoney: "Oui, le montant dépend du pays de la mission et votre logement, vos frais de transport et nourriture sont pris en charge.",
    descriptionDuration: "Une mission dure entre 1 an et 2 ans.",
  },
  {
    ...
    descriptionFor: "tous les jeunes entre 16 à 25 ans (jusqu'à 30 ans pour les jeunes en situation de handicap).",
    descriptionMoney: "Oui, à hauteur de 522 euros net par mois.",
    descriptionDuration: "De 6 à 12 mois",
  },
  {
    ...
    descriptionFor: "les jeunes de 16 à 25 ans (jusqu'à 30 ans pour les jeunes en situation de handicap).",
    descriptionMoney: "Oui",
    descriptionDuration: "De 6 à 12 mois",
  },
];
