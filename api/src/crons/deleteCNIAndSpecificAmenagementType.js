...
exports.handler = async () => {
  ...
  await cursor.addCursorFlag("noCursorTimeout", true).eachAsync(async function (young) {
    try {
      ...
      await slack.success({ title: "Suppression des CNI et des aménagements spécifiques pour les jeunes des cohortes passées", text: `${countModified}/${countTotal} Jeunes modifiés` });
    } catch (e) {
      capture(e);
