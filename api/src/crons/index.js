...
// TODO - REMOVE ME
function testCron() {
  console.log("IM a successfull useless cron");
}

function testFailedCron() {
  throw new Error("Yet another useless failed cron");
}

const CRONS = [
  cron("testCron", "* * * * *", testCron),
  cron("testFailedCron", "*/2 * * * *", testFailedCron),
