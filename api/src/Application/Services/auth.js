...
const { sendTemplate, regexp_exception_staging } = require("../../Infrastructure/Services/sendinblue");
const { JWT_SIGNIN_MAX_AGE, JWT_TRUST_TOKEN_MAX_AGE, JWT_SIGNIN_VERSION, JWT_TRUST_TOKEN_VERSION, checkJwtTrustTokenVersion } = require("../../Infrastructure/Services/jwt-options");
const { COOKIE_SIGNIN_MAX_AGE, COOKIE_TRUST_TOKEN_JWT_MAX_AGE, cookieOptions, logoutCookieOptions } = require("../../Infrastructure/Services/cookie-options");
