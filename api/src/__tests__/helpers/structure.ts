...
async function deleteStructureByIdHelper(structureId) {
  ...
  if (structure) await structure.deleteOne();
}
...
export { getStructuresHelper, getStructureByIdHelper, deleteStructureByIdHelper, createStructureHelper, expectStructureToEqual, notExistingStructureId };
