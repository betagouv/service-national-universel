...
export function getYoungWithCompleteParentsFixture(fields: Partial<YoungType> = {}): any {
  return {
    ...getNewYoungFixture(),
    parent1Status: "mother",
    parent1FirstName: faker.person.firstName(),
    parent1LastName: faker.person.lastName(),
    parent1Email: faker.internet.email({ firstName: faker.person.firstName(), lastName: faker.string.uuid() }).toLowerCase(),
    parent1Phone: faker.phone.number(),
    parent1PhoneZone: "FRANCE",
    parent1OwnAddress: "true",
    parent1Address: faker.location.streetAddress(),
    parent1coordinatesAccuracyLevel: "housenumber",
    parent1ComplementAddress: faker.location.secondaryAddress(),
    parent1Zip: faker.location.zipCode(),
    parent1City: faker.location.city(),
    parent1CityCode: faker.location.zipCode(),
    parent1Department: faker.helpers.arrayElement(departmentList),
    parent1Region: faker.helpers.arrayElement(regionList),
    ...
    parent1Inscription2023Token: faker.string.uuid(),
    parent1DataVerified: "true",
    parent1AddressVerified: "true",
    parent1AllowCovidAutotest: "true",
    parent1AllowImageRights: "true",
    parent1ContactPreference: "email",
    parent1AllowSNU: "true",
    parent1ValidationDate: faker.date.past(),
    parent2Status: "father",
    parent2FirstName: faker.person.firstName(),
    parent2LastName: faker.person.lastName(),
    parent2Email: faker.internet.email({ firstName: faker.person.firstName(), lastName: faker.string.uuid() }).toLowerCase(),
    parent2Phone: faker.phone.number(),
    parent2PhoneZone: "FRANCE",
    parent2OwnAddress: "false",
    parent2Address: faker.location.streetAddress(),
    parent2coordinatesAccuracyLevel: "street",
    parent2ComplementAddress: faker.location.secondaryAddress(),
    parent2Zip: faker.location.zipCode(),
    parent2City: faker.location.city(),
    parent2CityCode: faker.location.zipCode(),
    parent2Department: faker.helpers.arrayElement(departmentList),
    parent2Region: faker.helpers.arrayElement(regionList),
    ...
    parent2FromFranceConnect: "false",
    parent2Inscription2023Token: faker.string.uuid(),
    parent2DataVerified: "true",
    parent2AddressVerified: "true",
    parent2AllowCovidAutotest: "true",
    parent2AllowImageRights: "true",
    parent2ContactPreference: "phone",
    parent2AllowSNU: "true",
    parent2ValidationDate: faker.date.past(),
    rulesParent1: "true",
    rulesParent2: "true",
    ...fields,
  };
