        ...
        removed: [
          {
            ...
            classe: { name: "a", coloration: "", estimatedSeats: 0 },
            removedReason: "sameUaiDifferentEmail",
          },
          {
            etablissement: { uai: "sameUaiDifferentEmail" },
            referentEtablissement: { email: "test2@test.com" },
            classe: { name: "b", coloration: "", estimatedSeats: 0 },
            removedReason: "sameUaiDifferentEmail",
          },
          {
            etablissement: { uai: "" },
            referentEtablissement: { email: "pasduai@test.com" },
            classe: { name: "f", coloration: "", estimatedSeats: 0 },
            removedReason: "noUaiOrEmail",
          },
          { etablissement: { uai: "pasdemail" }, referentEtablissement: { email: "" }, classe: { name: "g", coloration: "", estimatedSeats: 0 }, removedReason: "noUaiOrEmail" },
          {
            numberDS: 1,
            etablissement: { uai: "sameUniqueId" },
            referentEtablissement: { email: "sameUniqueId@test.com" },
