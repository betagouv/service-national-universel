...
const { canSendFileByMailToYoung, canDownloadYoungDocuments, canEditYoung } = require("snu-lib");
const { FILE_KEYS, MILITARY_FILE_KEYS, SENDINBLUE_TEMPLATES, START_DATE_SESSION_PHASE1 } = require("snu-lib");
