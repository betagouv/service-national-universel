...
const { JWT_SIGNIN_VERSION, JWT_SIGNIN_MAX_AGE } = require("../../jwt-options");
...
router.post("/signup_verify", async (req, res) => {
  try {
    ...
    const token = jwt.sign({ __v: JWT_SIGNIN_VERSION, _id: young._id, passwordChangedAt: null, lastLogoutAt: null }, config.secret, { expiresIn: JWT_SIGNIN_MAX_AGE });
