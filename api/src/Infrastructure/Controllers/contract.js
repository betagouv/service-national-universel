...
const { ERRORS, isYoung, isReferent, timeout } = require("../../Application/Utils");
const { sendTemplate } = require("../Services/sendinblue");
const { APP_URL } = require("../Config/config");
const contractTemplate = require("../../Application/Templates/contractPhase2");
const { validateId, validateContract, validateOptionalId } = require("../../Application/Utils/validator");
const { serializeContract } = require("../../Application/Utils/serializer");
const { updateYoungPhase2Hours, updateStatusPhase2, updateYoungStatusPhase2Contract, checkStatusContract } = require("../../Application/Utils");
