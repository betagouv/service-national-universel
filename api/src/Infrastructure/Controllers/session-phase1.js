...
const sessionPhase1TokenModel = require("../Databases/Mongo/Models/sessionPhase1Token");
const schemaRepartitionModel = require("../Databases/Mongo/Models/PlanDeTransport/schemaDeRepartition");
const { ERRORS, updatePlacesSessionPhase1, isYoung, YOUNG_STATUS, uploadFile, deleteFile, getFile, updateHeadCenter, timeout } = require("../../Application/Utils");
...
const { serializeSessionPhase1, serializeCohesionCenter } = require("../../Application/Utils/serializer");
const { validateSessionPhase1, validateId } = require("../../Application/Utils/validator");
const { sendTemplate } = require("../Services/sendinblue");
const { ADMIN_URL } = require("../Config/config");
...
const { readTemplate, renderWithTemplate } = require("../../Application/Templates/droitImage");
const fetch = require("node-fetch");
const { phase1 } = require("../../Application/Templates/certificate/index");
