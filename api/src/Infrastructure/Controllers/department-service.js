...
const { ERRORS, isYoung, isReferent } = require("../../Application/Utils");
const { validateDepartmentService } = require("../../Application/Utils/validator");
const { serializeDepartmentService, serializeArray } = require("../../Application/Utils/serializer");
