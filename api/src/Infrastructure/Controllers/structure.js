...
const { validateId, validateStructure, validateStructureManager } = require("../../Application/Utils/validator");
const { serializeStructure, serializeArray, serializeMission } = require("../../Application/Utils/serializer");
const { serializeMissions, serializeReferents } = require("../Databases/ElasticSearch/es-serializer");
