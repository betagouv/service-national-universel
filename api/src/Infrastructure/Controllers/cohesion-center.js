...
const MeetingPointObject = require("../Databases/Mongo/Models/meetingPoint");
const BusObject = require("../Databases/Mongo/Models/bus");
const CohortModel = require("../Databases/Mongo/Models/cohort");
const { ERRORS, updatePlacesBus, sendAutoCancelMeetingPoint, isYoung, YOUNG_STATUS, updateCenterDependencies } = require("../../Application/Utils");
...
const { ADMIN_URL, ENVIRONMENT } = require("../Config/config");
const Joi = require("joi");
const { serializeCohesionCenter, serializeYoung, serializeSessionPhase1 } = require("../../Application/Utils/serializer");
const { validateId } = require("../../Application/Utils/validator");
const { getReferentManagerPhase2 } = require("../../Application/Utils");
const { getTransporter } = require("../../Application/Utils");
