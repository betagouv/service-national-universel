...
const { cookieOptions, COOKIE_SNUPPORT_MAX_AGE } = require("../Services/cookie-options");
const { capture } = require("../Services/sentry");
const zammood = require("../Services/zammood");
const { ERRORS, isYoung, uploadFile, getFile, SUPPORT_BUCKET_CONFIG } = require("../../Application/Utils");
const { ADMIN_URL, ENVIRONMENT, FILE_ENCRYPTION_SECRET_SUPPORT } = require("../Config/config.js");
...
const { getUserAttributes } = require("../../Application/Services/support");
