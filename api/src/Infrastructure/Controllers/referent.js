...
const StructureModel = require("../Databases/Mongo/Models/structure");
...
const { getQPV, getDensity } = require("../../Application/Services/geo");
...
const { validateId, validateSelf, validateYoung, validateReferent } = require("../../Application/Utils/validator");
const { serializeYoung, serializeReferent, serializeSessionPhase1, serializeStructure } = require("../../Application/Utils/serializer");
const { JWT_SIGNIN_MAX_AGE, JWT_SIGNIN_VERSION } = require("../Services/jwt-options");
...
const { getFilteredSessions, getAllSessions } = require("../../Application/Utils/cohort");
