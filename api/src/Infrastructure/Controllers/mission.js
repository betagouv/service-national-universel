...
const MissionObject = require("../Databases/Mongo/Models/mission");
const UserObject = require("../Databases/Mongo/Models/referent");
...
const { ERRORS, isYoung } = require("../../Application/Utils/index.js");
const { updateApplicationStatus, updateApplicationTutor } = require("../../Application/Services/application");
const { getTutorName } = require("../../Application/Services/mission");
const { validateId, validateMission } = require("../../Application/Utils/validator");
...
const { serializeMission, serializeApplication } = require("../../Application/Utils/serializer");
const patches = require("./patches");
const { sendTemplate } = require("../Services/sendinblue");
const { ADMIN_URL } = require("../Config/config");
const { putLocation } = require("../../Application/Services/api-adresse");
