...
const { capture, captureMessage } = require("../Services/sentry");
const ApplicationObject = require("../Databases/Mongo/Models/application");
const ContractObject = require("../Databases/Mongo/Models/contract");
...
const CohortObject = require("../Databases/Mongo/Models/cohort");
...
const { validateUpdateApplication, validateNewApplication, validateId } = require("../../Application/Utils/validator");
const { ENVIRONMENT, ADMIN_URL, APP_URL } = require("../Config/config");
const {
  ROLES,
...
const { serializeApplication, serializeYoung, serializeContract } = require("../../Application/Utils/serializer");
const {
  uploadFile,
  ERRORS,
  isYoung,
