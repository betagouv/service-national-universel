...
const { decrypt, encrypt } = require("../../Services/cryptoUtils");
const config = require("../../Config/config");
const { capture } = require("../../Services/sentry");
const YoungObject = require("../../Databases/Mongo/Models/young");
const ReferentModel = require("../../Databases/Mongo/Models/referent");
const SessionPhase1 = require("../../Databases/Mongo/Models/sessionPhase1");
const ApplicationModel = require("../../Databases/Mongo/Models/application");
const MissionModel = require("../../Databases/Mongo/Models/mission");
const CohortModel = require("../../Databases/Mongo/Models/cohort");
const AuthObject = require("../../../Application/Services/auth");
const LigneDeBusModel = require("../../Databases/Mongo/Models/PlanDeTransport/ligneBus");
...
const { sendTemplate, unsync } = require("../../Services/sendinblue");
const { cookieOptions, COOKIE_SIGNIN_MAX_AGE } = require("../../Services/cookie-options");
const { validateYoung, validateId, validatePhase1Document } = require("../../../Application/Utils/validator");
const patches = require("../patches");
const { serializeYoung, serializeApplication } = require("../../../Application/Utils/serializer");
const {
  canDeleteYoung,
  canGetYoungByEmail,
  canInviteYoung,
...
const { getFilteredSessions } = require("../../../Application/Utils/cohort");
const { anonymizeApplicationsFromYoungId } = require("../../../Application/Services/application");
const { anonymizeContractsFromYoungId } = require("../../../Application/Services/contract");
const { getFillingRate, FILLING_RATE_LIMIT } = require("../../../Application/Services/inscription-goal");
const { JWT_SIGNIN_VERSION } = require("../../Services/jwt-options");
...
router.post("/signup_verify", async (req, res) => {
  try {
    ...
    const token = jwt.sign({ __v: JWT_SIGNIN_VERSION, _id: young._id, passwordChangedAt: null, lastLogoutAt: null }, config.secret, { expiresIn: "30d" });
