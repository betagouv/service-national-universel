...
const DepartmentServiceModel = require("../../Databases/Mongo/Models/departmentService");
const { ERRORS, updatePlacesSessionPhase1, updateSeatsTakenInBusLine, autoValidationSessionPhase1Young } = require("../../../Application/Utils");
const { serializeYoung, serializeSessionPhase1 } = require("../../../Application/Utils/serializer");
