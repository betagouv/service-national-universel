...
const { ERRORS, notifDepartmentChange, YOUNG_STATUS_PHASE1, YOUNG_STATUS } = require("../../../Application/Utils");
...
const { serializeYoung } = require("../../../Application/Utils/serializer");
...
const { validateParents } = require("../../../Application/Utils/validator");
