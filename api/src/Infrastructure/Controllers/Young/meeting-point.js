...
const MeetingPointModel = require("../../Databases/Mongo/Models/meetingPoint");
const BusModel = require("../../Databases/Mongo/Models/bus");
const { ERRORS, updatePlacesBus, isYoung, isReferent } = require("../../../Application/Utils");
const { serializeMeetingPoint, serializeYoung } = require("../../../Application/Utils/serializer");
