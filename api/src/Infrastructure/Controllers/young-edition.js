...
const { ERRORS, notifDepartmentChange, updateSeatsTakenInBusLine, updatePlacesSessionPhase1 } = require("../../Application/Utils");
const { capture } = require("../Services/sentry");
const { validateFirstName } = require("../../Application/Utils/validator");
...
const { getDensity, getQPV } = require("../../Application/Services/geo");
