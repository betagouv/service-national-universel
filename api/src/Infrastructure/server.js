...
(async () => {
  await require("./Config/env-manager")();
  ...
  const { initSentry, capture } = require("./Services/sentry");
  ...
  const { PORT, APP_URL, ADMIN_URL, SUPPORT_URL, KNOWLEDGEBASE_URL, API_ANALYTICS_ENDPOINT, API_PDF_ENDPOINT, ENVIRONMENT } = require("./Config/config.js");
  ...
  //services
  app.use("/jeveuxaider", require("../Application/Services/jeveuxaider"));
