  ...
  try {
    ...
    return html
      ...
      .replace(
        ...
        sanitizeAll(
          "<b>Le</b> " +
            dayjs(await getDepartureDate(meetingPoint, session, young, cohort, regionsListDROMS))
              .locale("fr-FR")
      ...
      .replace(
        ...
        sanitizeAll(
          dayjs(await getReturnDate(meetingPoint, session, young, cohort, regionsListDROMS))
            .locale("fr")
            .format("dddd DD MMMM YYYY"),
        ),
      )
