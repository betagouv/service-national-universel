...
function _page1(doc) {
  ...
  doc.moveDown(2)
  _y = doc.y
  doc.image(path.join(PUBLIC_ROOTDIR, "images/logo-snu.png"), 40, _y, { width: 60, height: 60 });
  ...
  doc.moveDown(.5)
  doc.text(`Le décret n° 2020-922 du 29 juillet 2020 portant dispositions diverses relatives au service national universel a créé une réserve thématique dénommée « Réserve du service national universel », régie par les dispositions de la loi du 27 janvier 2017 relative à l’égalité et à la citoyenneté.`, MARGIN + 10, doc.y, {width})
  doc.moveDown(1)
  doc.text(`La réserve est ouverte aux mineurs âgés de quinze ans révolus satisfaisant aux conditions fixées par l'article 3 de la loi du 27 janvier 2017 susvisée et ayant participé au séjour de cohésion mentionné à l'article R. 113-1 du code du service national, qui accomplissent une mission d'intérêt général au titre du service national universel.`, {width});
  doc.moveDown(1)
  doc.text(`La mission d’intérêt général revêt « un caractère philanthropique, éducatif, environnemental, scientifique, social, sportif ou culturel, ou concourent à des missions de défense et de sécurité civile ou de prévention ou à la prise de conscience de la citoyenneté française et européenne ».`, {width});
  doc.moveDown(1)
  doc.text(`Les activités exercées dans ce cadre sont complémentaires des activités confiées aux personnels de l'organisme d'accueil et ne peuvent se substituer à la création d'un emploi ou au recrutement d'un stagiaire.`, {width});
  doc.moveDown(1)
  doc.text(`La phase d’engagement du volontaire, à l’issue du séjour de cohésion, couvre une durée minimale de quatre-vingt-quatre heures, qui peut être accomplie en continu ou, dans la limite d’une période d’une année, de manière fractionnée.`, {width});
  doc.moveDown(.5)
...
function _pageCharte(doc) {
  ...
  doc.moveDown(1)
  doc.text(`Les organismes qui accueillent les réservistes sont les services de l'Etat, les personnes morales de droit public, notamment les établissements publics et les collectivités territoriales, ainsi que les organismes sans but lucratif de droit français qui portent un projet d'intérêt général, répondant aux orientations de la réserve civique et aux valeurs qu'elle promeut.`)
  doc.moveDown(1)
  doc.text(`Une association cultuelle ou politique, une organisation syndicale, une congrégation, une fondation d'entreprise ou un comité d'entreprise ne peut accueillir de réserviste.`)
  doc.moveDown(1)
  doc.text(`Les organismes éligibles proposent aux réservistes des missions compatibles avec leurs obligations professionnelles. Il ne peut être opposé à l'employeur une quelconque forme de réquisition.`)
  doc.moveDown(1)
  ...
  doc.moveDown(1)
  doc.text(`Tout manquement aux principes et engagements énoncés par la présente charte justifie qu'il soit mis fin à la participation de la personne ou de l'organisme concerné à la réserve civique, ses sections territoriales ou ses réserves thématiques.`)
  doc.moveDown(1)
}
...
function render(doc, contract) {
  ...
  doc.font(FONT).text(`Le présent contrat, pour la réalisation de la mission indiquée ci-dessus, prend effet à la date de signature du présent contrat par les trois parties prenantes.`)
  doc.moveDown(1)
  ...
  doc.font(FONT).text(` de la structure d’accueil. Le volontaire bénéficie, par son tuteur, d’entretiens réguliers permettant un suivi de la réalisation des missions ainsi que, le cas échéant, d’un accompagnement renforcé.`)
  doc.moveDown(2)
  ...
  doc.text(`La structure d’accueil est chargée de la surveillance et de la sécurité du volontaire accueilli. L'organisme d'accueil le couvre des dommages subis par lui ou causés à des tiers dans l'accomplissement de sa mission.`)
  doc.moveDown(2)
  ...
  doc.text(`Le présent contrat de mission d’intérêt général peut être résilié moyennant un préavis d’une journée sauf en cas de force majeure ou de faute grave d’une des parties. Avant de résilier le contrat, la structure d’accueil prévient le représentant de l’Etat.`)
  doc.moveDown(2)
  ...
  doc.text(`La confirmation de la réalisation de la mission d'intérêt général est effectuée par le tuteur de mission qui, au nom de la structure d'accueil, effectue la procédure de fin de mission sur la plateforme.`)
  doc.moveDown(1)
  doc.moveDown(1)
