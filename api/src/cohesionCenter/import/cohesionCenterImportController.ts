...
import { checkColumnHeaders, importCohesionCenter, buildPathOnBucket, uploadAndConvertFile, xlsxMimetype } from "./cohesionCenterImportService";
...
router.post(
  ...
  async (req: RouteRequest<ImportCohesionCenterRoute>, res) => {
    try {
