...
console.log("🚀 ~ file: config.js:21 ~ process.env.SENTRY_TRACING_SAMPLE_RATE:", process.env.SENTRY_TRACING_SAMPLE_RATE);
console.log("🚀 ~ file: config.js:21QQQQ ~ process.env.SENTRY_TRACING_SAMPLE_RATE:", parseFloat(process.env.SENTRY_TRACING_SAMPLE_RATE));
const SENTRY_PROFILE_SAMPLE_RATE = process.env.SENTRY_PROFILE_SAMPLE_RATE || "";
console.log("🚀 ~ 111SENTRY_PROFILE_SAMPLE_RATE:", process.env.SENTRY_PROFILE_SAMPLE_RATE);
console.log("🚀 ~ 2222SENTRY_PROFILE_SAMPLE_RATE:", parseFloat(process.env.SENTRY_PROFILE_SAMPLE_RATE));
