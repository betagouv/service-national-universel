...
console.log("🚀 ~ process.env.SENTRY_TRACING_SAMPLE_RATE:", process.env.SENTRY_TRACING_SAMPLE_RATE);
console.log("🚀 ~ parseFloat(process.env.SENTRY_TRACING_SAMPLE_RATE):", parseFloat(process.env.SENTRY_TRACING_SAMPLE_RATE));
