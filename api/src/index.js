...
(async () => {
  ...
  console.log(`SENTRY_PROFILE_SAMPLE_RATE: ${process.env.SENTRY_PROFILE_SAMPLE_RATE}`);
  console.log(` SENTRY_TRACING_SAMPLE_RATE: ${process.env.SENTRY_TRACING_SAMPLE_RATE}`);
