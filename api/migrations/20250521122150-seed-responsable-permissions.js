...
const { PERMISSION_RESOURCES, PERMISSION_ACTIONS, ROLES, PERMISSION_CODES, PERMISSION_CODES_LIST, ROLE_JEUNE } = require("snu-lib");
module.exports = {
  async up(db, client) {
    // Mission
    ...
    await PermissionModel.create({
      code: PERMISSION_CODES.STRUCTURE_REGION_FULL,
    ...
    await PermissionModel.create({
      code: PERMISSION_CODES.STRUCTURE_DEPARTEMENT_FULL,
    ...
    await PermissionModel.create({
      code: PERMISSION_CODES.STRUCTURE_TETERESEAU_FULL,
