...
function canDeleteStructure(actor) {
...
const canAssignCohesionCenter = (user) => !FORCE_DISABLED_ASSIGN_COHESION_CENTER && isAdmin(user);

const FORCE_DISABLED_ASSIGN_MEETING_POINT = false;
const canAssignMeetingPoint = (user) => !FORCE_DISABLED_ASSIGN_MEETING_POINT && isReferentOrAdmin(user);
