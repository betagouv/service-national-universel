...
import { GRADES, region2department, RegionsDromComEtCorse, RegionsMetropole, RegionsMetropoleAndCorse } from "snu-lib";
...
export class PostSimulationsCleDromcomPayloadDto {
    @IsArray()
