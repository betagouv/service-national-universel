...
export class PlanDeTransportMapper {
    ...
    static toModel(planDeTransportDocument: PlanDeTransportDocument): PlanDeTransportModel {
        return {
            ...
            tauxRemplissageLigne: planDeTransportDocument.lineFillingRate,
            ...
            ligneFusionneeNumerosLignes: planDeTransportDocument.mergedBusIds,
            ligneMiroirNumeroLigne: planDeTransportDocument.mirrorBusId,
        };
    }
    ...
    static toEntity(
        ...
        return {
            ...
            lineFillingRate: planDeTransportModel.tauxRemplissageLigne,
            ...
            mergedBusIds: planDeTransportModel.ligneFusionneeNumerosLignes,
            mirrorBusId: planDeTransportModel.ligneMiroirNumeroLigne,
