...
export class JeuneMapper {
    ...
    static toModel(jeuneDocument: JeuneDocument): JeuneModel {
        return {
            ...
            codePostalNaissance: jeuneDocument.birthCityZip,
    ...
    > {
        return {
            ...
            address: jeuneModel.adresse,
            city: jeuneModel.ville,
            birthCity: jeuneModel.villeNaissance,
            birthCityZip: jeuneModel.codePostalNaissance,
            birthCountry: jeuneModel.paysNaissance,
            country: jeuneModel.pays,
            // Parent 1 Information
