// source: https://github.com/Papooch/nestjs-cls/blob/main/packages/transactional-adapters/transactional-adapter-mongoose/src/lib/transactional-adapter-mongoose.ts
