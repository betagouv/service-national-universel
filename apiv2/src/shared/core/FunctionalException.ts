...
export enum FunctionalExceptionCode {
    ...
    TOO_MANY_PENDING_EXPORTS = "TOO_MANY_PENDING_EXPORTS",
    SIMULATION_OUTDATED = "SIMULATION_OUTDATED",
    CAMPAIGN_NOT_FOUND = "CAMPAIGN_NOT_FOUND",
    CAMPAIGN_SHOULD_NOT_BE_GENERIC = "CAMPAIGN_SHOULD_NOT_BE_GENERIC",
    CAMPAIGN_NOT_GENERIC = "CAMPAIGN_NOT_GENERIC",
    CAMPAIGN_NOT_ARCHIVED = "CAMPAIGN_NOT_ARCHIVED",
    CAMPAIGN_ALREADY_ARCHIVED = "CAMPAIGN_ALREADY_ARCHIVED",
    CAMPAIGN_WITH_REF_CANNOT_BE_ARCHIVED = "CAMPAIGN_WITH_REF_CANNOT_BE_ARCHIVED",
    ...
    CAMPAGNE_DESTINATAIRES_NOT_FOUND = "CAMPAGNE_DESTINATAIRES_NOT_FOUND",
    FEATURE_FLAG_NOT_ENABLED = "FEATURE_FLAG_NOT_ENABLED",
    CLASSE_STATUT_INVALIDE_IMPORT_EN_MASSE = "CLASSE_STATUT_INVALIDE_IMPORT_EN_MASSE",
    CAMPAIGN_ALREADY_EXISTS_FOR_COHORT = "CAMPAIGN_ALREADY_EXISTS_FOR_COHORT",
    CLASSE_FULL = "CLASSE_FULL",
    JEUNE_ALREADY_EXISTS = "JEUNE_ALREADY_EXISTS",
    FILE_NOT_AVAILABLE_FOR_DOWNLOAD = "FILE_NOT_AVAILABLE_FOR_DOWNLOAD",
}
