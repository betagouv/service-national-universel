...
locals {
  ...
  domain_api       = "${local.app_api.subdomain}.${scaleway_domain_zone.main.id}"
  app_admin        = local.env.apps.admin
  domain_admin     = "${local.app_admin.subdomain}.${scaleway_domain_zone.main.id}"
  app_app          = local.env.apps.app
  domain_app       = "${local.app_app.subdomain}.${scaleway_domain_zone.main.id}"
...
resource "scaleway_domain_zone" "main" {
  ...
  subdomain  = "${local.env_key}.${local.project.dns_zone}"
}
