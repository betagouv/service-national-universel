        ...
        <Container>
          ...
          <section style={{ flex: 1 }}>
            ...
            <section className="button_container">
              <a href={`${supportURL}/base-de-connaissance/suis-je-eligible-a-un-sejour-de-cohesion-en-2022`} target="_blank" rel="noreferrer">
                <WhiteButton style={{ borderRadius: "8px" }}>Vérifiez votre éligibilité</WhiteButton>
              </a>
              <a href={`${supportURL}/base-de-connaissance/jetais-inscrit-en-2021-comment-me-reinscrire-en-2022`} target="_blank" rel="noreferrer">
