...
import { APPLICATION_STATUS_COLORS, dateForDatePicker, getAge, ROLES, translate, isReferentOrAdmin, formatDateFR } from "snu-lib";
import { copyToClipboard, translateModelFields } from "../utils";
                      ...
                      <div>
                        ...
                        <div>
                          ...
                          <p>
                            ...
                            1984 portant dispositions statutaires relatives à la fonction publique territoriale ou le chapitre Ier de la loi n° 86-33 du 9 janvier 1986 portant
...
`;
const ContractOld = ({ initialValues, onSubmit, contract, isYoungAdult, young, setModal, trimEmailValues, loadings }) => {
  return (
    <Formik validateOnChange={false} validateOnBlur={false} initialValues={initialValues} onSubmit={onSubmit}>
      {({ values, errors, touched, handleChange, handleSubmit, setFieldValue, validateForm }) => {
        const context = { values, errors, touched, handleChange };
                ...
                <ContractContainer>
                      ...
                      <>
                        ...
                        {young.parent2Email && (
                          <div>
                            ...
                            Email : <ContractField name="parent2Email" placeholder="Email" className="md" type="email" context={context} optional={true} validate={validateEmail} />
                            Téléphone :
                            <ContractField name="parent2Phone" placeholder="0123456789" className="md" context={context} optional={true} />
                          </div>
                        )}
                  ...
                  <div>
                    ...
                    <p>
                      ...
                      dans un cadre collectif, ponctuel ou, à titre exceptionnel, récurrent, quelles que soient ses aptitudes et compétences. Elle concourt au renforcement du lien
                    ...
                    <p>
                      ...
                      solidarité, l&apos;éducation, la culture, la santé, l&apos;environnement, le sport, la mémoire et la citoyenneté, la coopération internationale, la sécurité
                      ou encore les interventions d&apos;urgence en situation de crise ou d&apos;événement exceptionnel.
                    </p>
                    <p>
                      La réserve civique est complémentaire des autres formes d&apos;engagement citoyen que sont, d&apos;une part, la garde nationale et les réserves
                      opérationnelles et, d&apos;autre part, l&apos;engagement bénévole et volontaire.
                    ...
                    <p>
                      ...
                      et les collectivités territoriales, ainsi que les organismes sans but lucratif de droit français qui portent un projet d&apos;intérêt général, répondant aux
                    ...
                    <li>couvrir le réserviste contre les dommages subis par lui ou causés à des tiers dans l&apos;accomplissement de sa mission.</li>
                    <p>
                      Les organismes d&apos;accueil peuvent par ailleurs rembourser les frais réellement engagés par le réserviste dans l&apos;exercice de la mission qu&apos;ils
                      lui ont confiée.
                    </p>
                    <p>
                      Tout manquement aux principes et engagements énoncés par la présente charte justifie qu&apos;il soit mis fin à la participation de la personne ou de
