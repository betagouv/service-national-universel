...
import { canInviteYoung, getDepartmentNumber, isSuperAdmin, translateCniExpired, translateYoungSource, FeatureFlagName, YoungDto, UserDto } from "snu-lib";
        ...
        <div className="flex items-center justify-between py-8">
          ...
          <div className="flex items-center gap-2">
            ...
            {/* <ExportComponent
              ...
              transform={async (data: any) => mapInscriptionFields(data)}
            /> */}
            {[ROLES.REFERENT_DEPARTMENT, ROLES.REFERENT_REGION].includes(user.role) && (
              <ExportComponent
                ...
                // transform={async (data: any) => transformInscription(data)}
              />
            )}
          </div>
        </div>
