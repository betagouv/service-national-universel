...
export default function YoungRowConsent({ young }) {
  ...
  return (
    <>
      ...
      <ModalConfirmation
        ...
        title="Récolte des consentements à la participation"
        text={
          authorized ? (
            <p className="text-base leading-6 font-normal text-gray-900">
              Vous souhaitez déclarer que vous avez reçu l’autorisation écrite des représentants légaux pour le consentement à la participation de&nbsp;
            ...
            <p className="text-base leading-6 font-normal text-gray-900">
              Vous souhaitez déclarer que vous avez reçu le refus écrit des représentants légaux pour le consentement à la participation de&nbsp;
              <span className="font-bold">
                {young.firstName} {young.lastName}
              </span>
