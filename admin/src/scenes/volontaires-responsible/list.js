              ...
              <ExportComponent
                ...
                transform={(data) => {
                  return {
                    ...
                    Téléphone: data.youngPhone,
                    "Adresse du volontaire": data.youngAddress,
                    "Code postal du volontaire": data.youngZip,
                    "Ville du volontaire": data.youngCity,
                    "Département du volontaire": data.youngDepartment,
                    "Prénom représentant légal 1": data.youngParent1FirstName,
                    "Nom représentant légal 1": data.youngParent1LastName,
                    "Email représentant légal 1": data.youngParent1Email,
                    "Téléphone représentant légal 1": data.youngParent1Phone,
                    "Prénom représentant légal 2": data.youngParent2LastName,
                    "Nom représentant légal 2": data.youngParent2LastName,
                    "Email représentant légal 2": data.youngParent2Email,
                    "Téléphone représentant légal 2": data.youngParent2Phone,
