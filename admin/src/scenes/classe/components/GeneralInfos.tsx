...
export default function GeneralInfos({ classe, rights, cohorts, user, validatedYoung }: Props) {
    ...
    <Container title="Informations générales">
      <div className="flex items-stretch justify-stretch">
        <div className="flex-1">
          ...
          <InputText name="nameClasse" className="flex-1 mb-3" value={classe.name || ""} readOnly disabled />
          <Label title="Effectif prévisionnel" name="estimatedSeats" tooltip="Nombre d'élèves prévisionnel de la classe" />
          <InputText name="estimatedSeats" className="flex-1 mb-3" value={classe.estimatedSeats.toString()} readOnly disabled />
          <Label
          ...
          />
          <InputText name="totalSeats" className="flex-1 mb-3" value={classe.totalSeats.toString()} readOnly disabled />
