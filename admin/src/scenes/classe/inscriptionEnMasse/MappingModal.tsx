  ...
  const footer = (
    <div className="flex justify-center w-full mt-6">
      <button
        ...
        className="flex items-center justify-center px-6 py-3 rounded-lg bg-blue-600 text-white hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500"
        disabled={mappings.some((m) => !m.appField) || new Set(mappings.map((m) => m.appField)).size !== requiredFields.length}>
