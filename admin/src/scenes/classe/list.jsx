...
import { HiPlus, HiOutlineOfficeBuilding, HiOutlineChartSquareBar } from "react-icons/hi";
  ...
  return (
    <Page>
      <Header
        ...
        breadcrumb={[{ title: <HiOutlineChartSquareBar size={20} className="hover:text-gray-500" />, to: "/" }, { title: "Mes classes" }]}
        actions={[
