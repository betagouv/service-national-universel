...
import { HiPlus, HiOutlineOfficeBuilding, HiOutlineHome } from "react-icons/hi";
  ...
  return (
    <Page>
      <Header
        ...
        breadcrumb={[{ title: <HiOutlineHome size={20} className="hover:text-gray-500" />, to: "/" }, { title: "Mes classes" }]}
        actions={[
