    ...
    <div className="mt-4 flex w-3/4 flex-col items-center justify-center rounded-md border-[1px] border-dashed border-gray-400 py-4">
      ...
      {loading ? (
        ...
        <button
          ...
          className={`flex w-5/6 flex-row items-center justify-center gap-2 rounded-md bg-blue-600 py-2 disabled:opacity-50 ${disabled ? "cursor-default" : "cursor-pointer"} mt-7`}
        >
