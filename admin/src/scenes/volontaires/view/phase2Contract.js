          ...
          <Bloc title="">
            <Formik
              ...
              initialValues={{
                ...
                youngBirthdate: young.birthdate,
                  ...
                  <ContractContainer>
                    ...
                    <div>
                      <p>
                        ...
                        culturel, ou concourent à des missions de défense et de sécurité civile ou de prévention ou à la prise de conscience de la citoyenneté française et
                        européenne ». Le décret du 29 juillet 2020 a précisé qu’une mission d’intérêt général correspond à un engagement volontaire d’une durée minimale de
                        quatre-vingt-quatre heures, qui peut être accomplie de manière continue ou, dans la limite d’une période d’une année, de manière discontinue.
                      </p>
                    </div>
                    <div>
                      ...
                      <div>
                        ...
                        <div>
                          <Field validate={(v) => !v && requiredMessage} value={values.name} onChange={handleChange} name="name" placeholder="Nom" />
                          <Field validate={(v) => !v && requiredMessage} value={values.name} onChange={handleChange} name="name" placeholder="Prénom" /> agissant en qualité de{" "}
                          <Field validate={(v) => !v && requiredMessage} value={values.name} onChange={handleChange} name="name" placeholder="Rôle" />
                          <div>
                            Email :
                            <Field validate={(v) => !v && requiredMessage} value={values.name} onChange={handleChange} name="name" placeholder="alix@example.org" />
                          </div>
                        </div>
                      </div>
                      <h2>ET</h2>
                      <div>
                        ...
                        <div>
                          ...
                          <div>
                            Email :
                            <Field validate={(v) => !v && requiredMessage} value={values.name} onChange={handleChange} name="name" placeholder="ooo" />
                          </div>
                          <div>
                            Siret (optionnel) :
                            <Field validate={(v) => !v && requiredMessage} value={values.name} onChange={handleChange} name="name" placeholder="ooo" />
                      ...
                      <div>
                        ...
                        <div>
                          ...
                          <div>
                            demeurant :
                            <Field validate={(v) => !v && requiredMessage} value={values.youngAddress} onChange={handleChange} name="youngAddress" placeholder="ooo" />
                            <Field validate={(v) => !v && requiredMessage} value={values.youngCity} onChange={handleChange} name="youngCity" placeholder="ooo" />
                            <Field validate={(v) => !v && requiredMessage} value={values.youngDepartment} onChange={handleChange} name="youngDepartment" placeholder="ooo" />
                          </div>
                          email : <Field validate={(v) => !v && requiredMessage} value={values.youngEmail} onChange={handleChange} name="youngEmail" placeholder="ooo" />
                          téléphone : <Field validate={(v) => !v && requiredMessage} value={values.youngPhone} onChange={handleChange} name="youngPhone" placeholder="ooo" />
                        </div>
                      </div>
                      <hr />
                      ...
                      <div>
                        ...
                        <Field validate={(v) => !v && requiredMessage} value={values.name} onChange={handleChange} name="name" placeholder="ooo" />
                        <Field validate={(v) => !v && requiredMessage} value={values.name} onChange={handleChange} name="name" placeholder="ooo" />, disposant de l’autorité
                        parentale,
                        <div>
                          demeurant à
                          <Field validate={(v) => !v && requiredMessage} value={values.name} onChange={handleChange} name="name" placeholder="ooo" />
                      ...
                      <div>
                        <Field validate={(v) => !v && requiredMessage} value={values.name} onChange={handleChange} name="name" placeholder="ooo" />
                        <Field validate={(v) => !v && requiredMessage} value={values.name} onChange={handleChange} name="name" placeholder="ooo" />
                        s’engage à réaliser une mission d’intérêt général validée par l’autorité territoriale en charge du SNU. La mission
                        <Field validate={(v) => !v && requiredMessage} value={values.name} onChange={handleChange} name="name" placeholder="ooo" />
                        ...
                        <p>
                          ...
                          catégories de travaux définies en application de l’article L. 4153-8 du même code, interdites aux jeunes de moins de 18 ans, en ce qu’elles les
                      ...
                      <div>
                        ...
                        prenantes. La mission d’intérêt général débute le
                        <Field validate={(v) => !v && requiredMessage} value={values.name} onChange={handleChange} name="name" placeholder="ooo" />
                        jusqu’au
                        <Field validate={(v) => !v && requiredMessage} value={values.name} onChange={handleChange} name="name" placeholder="ooo" />
                      ...
                      <div>
                        ...
                        <Field validate={(v) => !v && requiredMessage} value={values.name} onChange={handleChange} name="name" placeholder="ooo" />
                        <Field validate={(v) => !v && requiredMessage} value={values.name} onChange={handleChange} name="name" placeholder="ooo" />, exerçant une activité au sein
                      ...
                      <div>
                        <p>
                          ...
                          structure d’accueil s’engage à proposer des missions permettant la mobilisation du volontaire en faveur de l’intérêt général. Un mentor est nommé au sein
                          de la structure afin de s’assurer du suivi du volontaire et de la qualité des conditions de son accueil.
                        </p>
                        <p>
                        ...
                        <p>
                          Le volontaire s’engage à respecter le règlement intérieur de la structure qui l’accueille, à respecter les personnes, le matériel et les locaux et à agir
                          en conformité avec les exigences de son engagement dans le cadre du SNU : ponctualité, politesse, implication. Le volontaire est tenu à la discrétion pour
                          les faits et informations dont il a connaissance dans l’exercice de ses missions. Il est également tenu aux obligations de convenance et de réserve
                      ...
                      <div>
                        La confirmation de la réalisation de la mission d'intérêt général est effectuée par le tuteur de mission qui, au nom de la structure d'accueil, effectue la
                        procédure de fin de mission sur la plateforme. La validation est conditionnée à la réalisation de{" "}
                        <Field validate={(v) => !v && requiredMessage} value={values.name} onChange={handleChange} name="name" placeholder="ooo" /> de mission au minimum au sein de
                        la structure. La mission est accomplie de manière continue, ou dans la limite de la période d’une année, de manière discontinue.
                      </div>
                      <div>
                        Le
                        <Field validate={(v) => !v && requiredMessage} value={values.name} onChange={handleChange} name="name" placeholder="ooo" />
                      ...
                      <div>
                        Le volontaire, <Field validate={(v) => !v && requiredMessage} value={values.name} onChange={handleChange} name="name" placeholder="ooo" /> représenté par
                    ...
                    <div>
                      ...
                      <p>
                        La réserve civique, ses sections territoriales et les réserves thématiques qu'elle comporte favorisent la participation de tout citoyen à ces missions, dans
                        un cadre collectif, ponctuel ou, à titre exceptionnel, récurrent, quelles que soient ses aptitudes et compétences. Elle concourt au renforcement du lien
                        social en favorisant la mixité sociale.
                      </p>
                      <p>
                        ...
                        solidarité, l'éducation, la culture, la santé, l'environnement, le sport, la mémoire et la citoyenneté, la coopération internationale, la sécurité ou encore
                      ...
                      <p>
                        Sous réserve de satisfaire aux conditions légales et réglementaires qui régissent la réserve civique et ses sections territoriales et aux règles spécifiques
                        propres aux réserves thématiques qu'elle comporte, peut être réserviste toute personne volontaire souhaitant s'engager dans le respect des principes
                        directeurs de la réserve civique.
                      </p>
