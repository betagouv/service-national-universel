...
import { copyToClipboard, formatDateFR, translate } from "../../../utils";
        ...
        <div className="mb-3">
          <div className="flex items-center justify-between px-4">
            ...
            {equivalence.status === "WAITING_VERIFICATION" ? (
              ...
              <div className="border-[1px] border-gray-300 rounded-lg mt-3 px-3 py-2.5">
                <div className="relative" ref={ref}>
                  <button className="flex justify-between items-center cursor-pointer disabled:opacity-50 disabled:cursor-wait min-w-[200px]" onClick={() => setOpen((e) => !e)}>
