...
import { debounce, formatDateFR, translate } from "../../../utils";
        ...
        <div className="flex w-1/3 flex-col text-[12px] leading-[18px]">
          <div className="text-gray-500">
            ...
            <span className=" text-gray-900">
              {formatDateFR(data?.ligneBus.departuredDate)} {data?.ligneToPoint.departureHour}
            </span>
          </div>
          <div className=" text-gray-500">
            Retour :{" "}
            <span className=" text-gray-900">
              {formatDateFR(data?.ligneBus?.returnDate)} {data?.ligneToPoint.returnHour}
            </span>
          </div>
        </div>
        <div className="cursor-pointer" onClick={onSend}>
