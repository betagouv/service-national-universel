...
export default function Details({ selectedFilters, role, sessionId, centerId }) {
  ...
  const base = [ROLES.HEAD_CENTER, ROLES.HEAD_CENTER_ADJOINT, ROLES.REFERENT_SANITAIRE].includes(role) ? `/centre/${centerId}/${sessionId}/general` : "/inscription";
  ...
  return (
    <div className="flex w-[40%] flex-col items-center rounded-lg bg-white py-6 px-8 shadow-[0_8px_16px_-3px_rgba(0,0,0,0.05)]">
      <div className="flex w-full flex-row justify-between">
        ...
        {![ROLES.HEAD_CENTER, ROLES.HEAD_CENTER_ADJOINT, ROLES.REFERENT_SANITAIRE].includes(role) && (
