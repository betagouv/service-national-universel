                  ...
                  <div className="flex flex-col gap-3">
                    <div className="flex items-center gap-2">
                      ...
                      <ReactTooltip id="téléchargement_schema" type="light" place="top" effect="solid" className="custom-tooltip-radius !opacity-100 !shadow-md" tooltipRadius="6">
                        <p className=" w-[275px] list-outside !px-2 !py-1.5 text-left text-xs text-gray-600">
                          Ouverture ou fermeture pour les utilisateurs de la possibilité de télécharger le schéma de répartition. Activer cette option entraînera également les
                          notifications au transporteur à chaque modification du schéma de répartition.
                        </p>
                      </ReactTooltip>
                    </div>
                    <ToggleDate
