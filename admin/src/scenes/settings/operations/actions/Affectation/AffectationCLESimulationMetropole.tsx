  ...
  return (
    <div className="flex items-center justify-between px-4">
      <div className="flex gap-2">
        ...
        <Tooltip id="affectation-cle-metropole" title="Permet d’effectuer les simulations et les affectation des jeunes CLE pour les cohortes de métropole (hors Corse)">
