...
import { canCreateMeetingPoint, getResultLabel } from "../../utils";
            ...
            <div className="flex flex-row  justify-center gap-4 items-center">
              <div className="flex flex-col w-2/5 bg-white rounded-xl p-9 self-stretch">
                ...
                <div className="flex flex-col space-y-4">
                  ...
                  {/* todo: select departement and region */}
                  <div className="flex flex-col justify-center border-[1px] border-gray-300 w-2/3 px-3 py-2 rounded-lg mt-3">
                    {data?.departureDepartment ? <div className="text-xs leading-4 font-normal text-gray-500">Département</div> : null}
                    <input
                      className="w-full text-sm leading-5 font-normal ::placeholder:text-gray-500"
                      ...
                      onChange={(e) => {
                        e.persist();
                        setData((prev) => ({ ...prev, departureDepartment: e.target.value }));
                      }}
                    />
                  </div>
