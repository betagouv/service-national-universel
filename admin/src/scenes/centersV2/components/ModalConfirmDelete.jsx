...
export default function ModalConfirmDelete({ isOpen, onCancel, onDelete, title, message, mention = null }) {
  return (
    <ModalTailwind isOpen={isOpen} onClose={onCancel} className="w-[512px] rounded-lg bg-white shadow-xl">
      <div className="flex w-full flex-col items-center gap-4 p-8">
        ...
        {mention !== null ? <div className="text-sm leading-5 text-gray-400">{mention}</div> : null}
