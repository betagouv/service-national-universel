  ...
  async function handleUpload(e: ChangeEvent<HTMLInputElement>) {
    ...
    try {
      ...
      if (res.code === "FILE_CORRUPTED") {
        ...
        toastr.error("Une erreur est survenue lors de l'import du fichier des centres", "");
        capture(res.code);
        setUploadError("Le fichier des centres doit contenir : " + res.code);
      } else {
    ...
    <Container>
      <div className="mt-8 flex w-full flex-col items-center justify-center bg-white rounded-xl px-8 pt-12 pb-24">
        <div className="bg-gray-50 w-full flex-col pb-5">
          <h1 className="text-lg leading-6 font-medium text-gray-900 text-center mt-12 mb-2">Mettre à jour les centres</h1>
