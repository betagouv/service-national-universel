...
import { Table, ActionBox, MultiLine } from "../../../components/list";
...
export default function FiltersDemoVolontaire() {
  ...
  const filterArray = [
    { title: "Cohorte", name: "cohort", parentGroup: "Général", missingLabel: "Non renseignée" },
    { title: "Région", name: "region", parentGroup: "Général", missingLabel: "Non renseignée" },
    { title: "Département", name: "department", parentGroup: "Général", missingLabel: "Non renseignée" },
    { title: "Date de début", name: "createdAtFrom", parentGroup: "Créé le", missingLabel: "Non renseignée" },
    { title: "Date de fin", name: "createdAtTo", parentGroup: "Créé le", missingLabel: "Non renseignée" },
    { title: "Classe", name: "grade", parentGroup: "Dossier", translate: translateGrade, missingLabel: "Non renseignée" },
  ];

  const sortOptions = [
    { label: "Nom (A > Z)", field: "lastName", order: "asc" },
    { label: "Nom (Z > A)", field: "lastName", order: "desc" },
    { label: "Prénom (A > Z)", field: "firstName", order: "asc" },
    { label: "Prénom (Z > A)", field: "firstName", order: "desc" },
    ...
    { label: "Dernière connexion (récent > ancien)", field: "lastLoginAt", order: "desc" },
    { label: "Dernière connexion (ancien > récent)", field: "lastLoginAt", order: "asc" },
  ];
