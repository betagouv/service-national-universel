...
export default function FilterPopOver({ filter, data, selectedFilters, setSelectedFilters }) {
      ...
      {({ open }) => (
        <>
          ...
          <Transition
            ...
            <Popover.Panel className="absolute left-[101%] z-20 w-[400px] -translate-y-[36px]">
