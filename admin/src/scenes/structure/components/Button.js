...
export default function Button({ disabled, onClick, children, loading, category = "primary", className }) {
  const styles = {
    ...
    tertiary:
      "border-[1px] rounded-lg border-grey-300 bg-[#ffffff] text-gray-500 py-2 px-8 hover:bg-[#f9fafb] transition text-sm justify-center disabled:opacity-60 disabled:cursor-not-allowed",
  };
  return (
