                  ...
                  <div className="flex flex-col gap-2">
                    ...
                    {infosHover || infosClick ? (
                      <div className="text-xs grid space-y-1 text-gray-500">
                        <div>
                          <span className="underline text-gray-900 mr-1">Général :</span>concerne toutes les informations générales de la mission . <strong>La source </strong>
                          correspond à la plateforme sur laquelle a été déposée la mission{" "}
                          <a href={`${supportURL}/base-de-connaissance/missions-de-la-plateforme-jeveuxaidergouvfr`} target="_blank" rel="noreferrer" className="hover:underline">
                            JVA & SNU
                          </a>
                        </div>
                        <div>
                        ...
                        <div>
                          <span className="underline text-gray-900 mr-1">Dates :</span>permettent de filtrer les missions dont les dates de début et de fin sont inclues dans la
                          borne temporelle. Attention les missions dont seulement 1 jour est inclus seront également affichées.
                        </div>
                      </div>
                    ) : null}
                  </div>
