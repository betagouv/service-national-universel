...
const articles = [
  {
    ...
    url: `${knowledgebaseURL}/base-de-connaissance/je-narrive-pas-a-me-connecter`,
  },
  {
    title: "Je crée ma structure",
    emoji: "📝",
    body: "Connectez-vous à l'espace d'inscription structure...",
    url: `${knowledgebaseURL}/base-de-connaissance/je-cree-ma-structure-1-1`,
  },
  {
  ...
  },
  {
    ...
    url: `${knowledgebaseURL}/base-de-connaissance/jinvite-un-nouvel-utilisateur-referent-chef-de-centre-1-1`,
  },
];
