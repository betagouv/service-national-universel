  ...
  function updateFilter(n) {
    setFilter({
      ...(filter || {
        ...
        region: [],
        department: [],
        cohort: filter?.cohort || ["Février 2023 - C", "Avril 2023 - B", "Avril 2023 - A", "Juin 2023", "Juillet 2023", "Octobre 2023 - NC"],
      }),
      ...n,
    });
  }
    ...
    <>
      <Row>
        <Col style={{ display: "flex" }}>
          <h2 className="m-0 text-2xl font-bold">Inscriptions</h2>
          {filter ? (
            <FiltersList>
