...
import { CohortType, LigneBusDto, YOUNG_STATUS_PHASE1 } from "snu-lib";
            ...
            <div className="scroll-y-auto overflow-y-auto max-h-[80vh]">
              ...
              <div className="flex justify-center items-center gap-8 mb-6">
                ...
                <div className="flex justify-center items-center gap-2.5">
                  <Link
                    to={`/volontaire?cohort=${encodeURIComponent(cohort!.name)}&statusPhase1=${YOUNG_STATUS_PHASE1.AFFECTED}~${YOUNG_STATUS_PHASE1.DONE}&page=1`}
                    target="_blank"
                    className="w-full">
